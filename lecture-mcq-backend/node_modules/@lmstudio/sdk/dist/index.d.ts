...
declare interface ContentBlockAppendToolRequestOpts {
    toolCallId: string;
    name: string;
    parameters: Record<string, any>;
}

declare interface ContentBlockAppendToolResultOpts {
    toolCallId: string;
    content: string;
}

declare interface ContentBlockReplaceToolRequestOpts {
    toolCallId: string;
    name: string;
    parameters: Record<string, any>;
}
...
export declare class PredictionProcessContentBlockController {
    ...
    appendToolRequest({ toolCallId, name, parameters }: ContentBlockAppendToolRequestOpts): void;
    replaceToolRequest({ toolCallId, name, parameters }: ContentBlockReplaceToolRequestOpts): void;
    appendToolResult({ toolCallId, content }: ContentBlockAppendToolResultOpts): void;
    replaceText(text: string): void;
...
export declare class ProcessingController {
    ...
    requestConfirmToolCall({ pluginIdentifier, toolName, toolArgs, }: RequestConfirmToolCallOpts): Promise<RequestConfirmToolCallResult>;
}
 ...
 * @experimental WIP
 */
declare interface RequestConfirmToolCallOpts {
 ...
 * @experimental WIP
 */
declare type RequestConfirmToolCallResult = {
    type: "allow";
...
export declare class ToolsProviderController {
    ...
    constructor(client: LMStudioClient, pluginConfig: KVConfig);
    getPluginConfig<TVirtualConfigSchematics extends VirtualConfigSchematics>(configSchematics: ConfigSchematics<TVirtualConfigSchematics>): ParsedConfig<TVirtualConfigSchematics>;
}
